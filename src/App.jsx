...
function App() {
  ...
  useFrame(() => {
    ...
    target.current.x = THREE.MathUtils.lerp(target.current.x, mouse.current.x * 0.5, 0.075);
    target.current.y = THREE.MathUtils.lerp(target.current.y, mouse.current.y * 0.5, 0.075);
    ...
    <>
      ...
      <ErrorBoundary>
        ...
        <motion.div 
          ...
          animate={{
            backgroundColor: backgroundColors[activeCardIndex % backgroundColors.length]
          }}
